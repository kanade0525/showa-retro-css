...
**No JavaScript. No images.** Everything is gradients and inline SVG data URIs. 60KB minified, **12.5KB gzipped**. Import only what you need and it drops to 8KB.
...
| --- | --- | --- |
| Everything | 60.0KB | 12.5KB |
| Common set (base, type, signs, buttons, tables, layout, forced colours) | 23.8KB | 6.0KB |
| Base and typesetting only | 7.9KB | 2.7KB |
